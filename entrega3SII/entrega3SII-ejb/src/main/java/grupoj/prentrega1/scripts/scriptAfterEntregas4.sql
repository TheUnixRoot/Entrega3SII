CREATE TABLE USUARIO (ID BIGINT NOT NULL, DTYPE VARCHAR(31), APELLIDOS VARCHAR(255), borrado SMALLINT DEFAULT 0 NOT NULL, email VARCHAR(255) NOT NULL UNIQUE, FECHANACIMIENTO DATE, MULTIMEDIA BLOB(2147483647), nombre VARCHAR(255) NOT NULL, password VARCHAR(255) NOT NULL, TELEFONO VARCHAR(255), tipoNotificacionesRecibir VARCHAR(255) NOT NULL, GEOLOCALIZACION_ID BIGINT, PRIMARY KEY (ID))
...
CREATE TABLE ANUNCIO (ID BIGINT NOT NULL, DIAS_CONTRATADOS INTEGER NOT NULL, EMPRESA VARCHAR(255), FECHA_PUBLIC DATE NOT NULL, LUGAR VARCHAR(255), MULTIMEDIA BLOB(2147483647) NOT NULL, ONLINE SMALLINT DEFAULT 0, admin_fk BIGINT NOT NULL, PRIMARY KEY (ID))
CREATE TABLE EVENTO (ID BIGINT NOT NULL, BORRADO SMALLINT DEFAULT 0 NOT NULL, DESCRIPCION VARCHAR(255), DONDE_COMPRAR VARCHAR(255), FECHA_FIN DATE NOT NULL, FECHA_INICIO DATE NOT NULL, MULTIMEDIA BLOB(2147483647), NOMBRE VARCHAR(255) NOT NULL, PRECIO FLOAT, VALIDADO SMALLINT DEFAULT 0 NOT NULL, ocurre_en_FK BIGINT NOT NULL, subido_por_FK BIGINT, PRIMARY KEY (ID))
CREATE TABLE FORMULARIO (ID BIGINT NOT NULL, notificacion_fk BIGINT NOT NULL, usuario_fk BIGINT NOT NULL, PRIMARY KEY (ID))
CREATE TABLE GEOLOCALIZACION (ID BIGINT NOT NULL, CIUDAD VARCHAR(255) NOT NULL, DIRECCION VARCHAR(255) NOT NULL, PRIMARY KEY (ID))
CREATE TABLE LUGAR (ID BIGINT NOT NULL, BORRADO SMALLINT DEFAULT 0 NOT NULL, DESCRIPCION VARCHAR(255), FOTOS BLOB(2147483647), NOMBRE VARCHAR(255) NOT NULL, tiene_geolocalizacion BIGINT NOT NULL, PRIMARY KEY (ID))
...
CREATE TABLE VALORACION_EVE (ID BIGINT NOT NULL, CALIFICACION INTEGER NOT NULL, COMENTARIO VARCHAR(255), FOTOS BLOB(2147483647), realizado_por_fk BIGINT NOT NULL, valoracion_sobre_fk BIGINT NOT NULL, PRIMARY KEY (ID))
CREATE TABLE VALORACION_LUG (ID BIGINT NOT NULL, CALIFICACION INTEGER NOT NULL, COMENTARIO VARCHAR(255), FOTOS BLOB(2147483647), realizado_por_fk BIGINT NOT NULL, valoracion_sobre_fk BIGINT NOT NULL, PRIMARY KEY (ID))
